...
This will open the device definition in your default editor (defined by `KUBE_EDITOR`, `EDITOR` environment variables, or defaults to `vi`). You can also specify a different editor:
