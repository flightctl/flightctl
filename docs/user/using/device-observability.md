...
> [!NOTE]
> For information about adding the OpenTelemetry Collector to device images, see [Adding OpenTelemetry Collector to Devices](../building/building-images.md#optional-adding-opentelemetry-collector-to-devices).

> [!NOTE]
> For information about agent diagnostics (metrics, profiling, and audit logs), see [Diagnosing Agent Issues](diagnosing-agent-issues.md).
