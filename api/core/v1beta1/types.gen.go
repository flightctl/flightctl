...
const (
	...
	CatalogItemCategoryAsset       CatalogItemCategory = "asset"
...
const (
	...
	ResourceKindCatalogItem               ResourceKind = "CatalogItem"
...
// CatalogItemArtifactType Type of related artifact. Includes bootc-image-builder output formats. Defaults to container if only one related item.
...
// CatalogItemReference Reference to the primary artifact and optional related artifacts.
type CatalogItemReference struct {
	// Related Related artifacts (e.g., qcow2, ISO for bootc images).
	Related *[]CatalogItemRelatedReference `json:"related,omitempty"`

	// Uri Primary artifact URI without version tag. Supports OCI references, URLs, S3 paths, etc.
	Uri string `json:"uri"`
}

// CatalogItemRelatedReference A related artifact reference.
type CatalogItemRelatedReference struct {
	// Name Optional human-readable display name for this artifact.
	Name *string `json:"name,omitempty"`

	// Type Type of related artifact. Includes bootc-image-builder output formats. Defaults to container if only one related item.
...
type CatalogItemSpec struct {
	...
	// Reference Reference to the primary artifact and optional related artifacts.
