...
//go:generate env PATH=../../../bin:$PATH protoc --go_out=. --go_opt=paths=source_relative --go-grpc_out=. --go-grpc_opt=paths=source_relative enrollment.proto
...
//go:generate go run -modfile=../../../tools/go.mod go.uber.org/mock/mockgen -source=enrollment_grpc.pb.go -destination=mock_enrollment_service.go -package=grpc_v1
