...
type embeddedAppTypeHandler interface {
	...
	CollectOCITargets(ctx context.Context, configProvider client.PullConfigProvider) ([]dependency.OCIPullTarget, error)
}
...
func (e *embeddedQuadletBehavior) CollectOCITargets(_ context.Context, configProvider client.PullConfigProvider) ([]dependency.OCIPullTarget, error) {
...
func (e *embeddedComposeBehavior) CollectOCITargets(_ context.Context, configProvider client.PullConfigProvider) ([]dependency.OCIPullTarget, error) {
