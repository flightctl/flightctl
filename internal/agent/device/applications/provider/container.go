...
func (p *containerProvider) collectOCITargets(ctx context.Context, configProvider client.PullConfigProvider) (dependency.OCIPullTargetsByUser, error) {
...
func (p *containerProvider) extractNestedTargets(_ context.Context, _ client.PullConfigProvider) (*AppData, error) {
	// Container apps don't have nested targets to extract
	return &AppData{}, nil
}

func (p *containerProvider) parentIsAvailable(_ context.Context) (ref string, digest string, available bool, err error) {
