...
func (m *MockappProvider) collectOCITargets(ctx context.Context, configProvider client.PullConfigProvider) (dependency.OCIPullTargetsByUser, error) {
	m.ctrl.T.Helper()
...
func (m *MockappProvider) extractNestedTargets(ctx context.Context, configProvider client.PullConfigProvider) (*AppData, error) {
	m.ctrl.T.Helper()
