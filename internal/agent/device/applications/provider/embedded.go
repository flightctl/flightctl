...
func (p *embeddedProvider) collectOCITargets(ctx context.Context, configProvider client.PullConfigProvider) (dependency.OCIPullTargetsByUser, error) {
...
func (p *embeddedProvider) extractNestedTargets(_ context.Context, _ client.PullConfigProvider) (*AppData, error) {
	// Embedded apps don't have nested targets to extract
	return &AppData{}, nil
}

func (p *embeddedProvider) parentIsAvailable(_ context.Context) (ref string, digest string, available bool, err error) {
