	...
	testCases := []struct {
	...
	}{
		{
			...
			setupMocks: func(mockSystemdMgr *systemd.MockManager, mockRW *fileio.MockReadWriter, mockExec *executer.MockExecuter) {
				...
				mockSystemdMgr.EXPECT().ListDependencies(gomock.Any(), "test-id-flightctl.target").Return([]string{"test-id-app.service"}, nil)
				...
				mockSystemdMgr.EXPECT().Start(gomock.Any(), "test-id-flightctl.target").Return(nil)
			},
			wantErr: false,
		},
		{
			...
			setupMocks: func(mockSystemdMgr *systemd.MockManager, mockRW *fileio.MockReadWriter, mockExec *executer.MockExecuter) {
				mockSystemdMgr.EXPECT().DaemonReload(gomock.Any()).Return(nil)
				mockSystemdMgr.EXPECT().ListDependencies(gomock.Any(), "test-id-flightctl.target").Return([]string{"test-id-app.service"}, nil)
				mockSystemdMgr.EXPECT().Stop(gomock.Any(), "test-id-flightctl.target").Return(nil)
				mockSystemdMgr.EXPECT().Stop(gomock.Any(), "test-id-app.service").Return(nil)
				mockSystemdMgr.EXPECT().ListUnitsByMatchPattern(gomock.Any(), []string{"test-id-app.service"}).
					Return([]client.SystemDUnitListEntry{{Unit: "test-id-app.service", ActiveState: string(api.SystemdActiveStateInactive)}}, nil)
		...
		},
		{
			...
			setupMocks: func(mockSystemdMgr *systemd.MockManager, mockRW *fileio.MockReadWriter, mockExec *executer.MockExecuter) {
				// Remove phase
				mockSystemdMgr.EXPECT().ListDependencies(gomock.Any(), "test-id-flightctl.target").Return([]string{"test-id-app.service"}, nil).Times(2)
				mockSystemdMgr.EXPECT().Stop(gomock.Any(), "test-id-flightctl.target").Return(nil)
				mockSystemdMgr.EXPECT().Stop(gomock.Any(), "test-id-app.service").Return(nil)
				mockSystemdMgr.EXPECT().ListUnitsByMatchPattern(gomock.Any(), []string{"test-id-app.service"}).
...
func TestQuadlet_add(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			setupMocks: func(mockSystemdMgr *systemd.MockManager, mockRW *fileio.MockReadWriter, mockExec *executer.MockExecuter) {
				mockSystemdMgr.EXPECT().ListDependencies(gomock.Any(), "test-id-flightctl.target").Return([]string{"test-id-custom.service"}, nil)
		...
		},
		{
			...
			setupMocks: func(mockSystemdMgr *systemd.MockManager, mockRW *fileio.MockReadWriter, mockExec *executer.MockExecuter) {
				mockSystemdMgr.EXPECT().ListDependencies(gomock.Any(), "test-id-flightctl.target").Return([]string{"test-id-mypod-pod.service"}, nil)
		...
		},
		{
			...
			setupMocks: func(mockSystemdMgr *systemd.MockManager, mockRW *fileio.MockReadWriter, mockExec *executer.MockExecuter) {
				mockSystemdMgr.EXPECT().ListDependencies(gomock.Any(), "test-id-flightctl.target").Return([]string{"test-id-app1.service", "test-id-app2.service"}, nil)
		...
		},
		{
			...
			setupMocks: func(mockSystemdMgr *systemd.MockManager, mockRW *fileio.MockReadWriter, mockExec *executer.MockExecuter) {
				mockSystemdMgr.EXPECT().ListDependencies(gomock.Any(), "test-id-flightctl.target").Return(nil, fmt.Errorf("list dependencies failed"))
		...
		},
		{
			...
			setupMocks: func(mockSystemdMgr *systemd.MockManager, mockRW *fileio.MockReadWriter, mockExec *executer.MockExecuter) {
				...
				mockSystemdMgr.EXPECT().ListUnitsByMatchPattern(gomock.Any(), []string{"test-id-app.service"}).
					Return([]client.SystemDUnitListEntry{{Unit: "test-id-app.service", LoadState: string(api.SystemdLoadStateLoaded)}}, nil)
				mockSystemdMgr.EXPECT().Start(gomock.Any(), "test-id-flightctl.target").Return(fmt.Errorf("start failed"))
				...
				mockSystemdMgr.EXPECT().ListDependencies(gomock.Any(), "test-id-flightctl.target").Return([]string{"test-id-app.service"}, nil)
				mockSystemdMgr.EXPECT().Stop(gomock.Any(), "test-id-flightctl.target").Return(nil).AnyTimes()
		...
		},
		{
			...
			setupMocks: func(mockSystemdMgr *systemd.MockManager, mockRW *fileio.MockReadWriter, mockExec *executer.MockExecuter) {
				...
				mockRW.EXPECT().RemoveFile("/etc/systemd/system/test-id-flightctl.target").Return(nil).AnyTimes()
				mockExec.EXPECT().ExecuteWithContext(gomock.Any(), "podman", gomock.Any()).Return("[]", "", 0).AnyTimes()
			},
			wantErr: true,
		},
		{
			...
			setupMocks: func(mockSystemdMgr *systemd.MockManager, mockRW *fileio.MockReadWriter, mockExec *executer.MockExecuter) {
				mockSystemdMgr.EXPECT().ListDependencies(gomock.Any(), "app-with-vols-flightctl.target").Return([]string{"app-with-vols-app.service"}, nil)
				...
				mockSystemdMgr.EXPECT().Start(gomock.Any(), "app-with-vols-flightctl.target").Return(nil)
			},
			wantErr: false,
		},
		{
			...
			setupMocks: func(mockSystemdMgr *systemd.MockManager, mockRW *fileio.MockReadWriter, mockExec *executer.MockExecuter) {
				mockSystemdMgr.EXPECT().ListDependencies(gomock.Any(), "app-mixed-vols-flightctl.target").Return([]string{"app-mixed-vols-app.service"}, nil)
				...
				mockSystemdMgr.EXPECT().Start(gomock.Any(), "app-mixed-vols-flightctl.target").Return(nil)
			},
			wantErr: false,
		},
		{
			...
			setupMocks: func(mockSystemdMgr *systemd.MockManager, mockRW *fileio.MockReadWriter, mockExec *executer.MockExecuter) {
				// First call during add
				mockSystemdMgr.EXPECT().ListDependencies(gomock.Any(), "app-vol-fail-flightctl.target").Return([]string{"app-vol-fail-app.service"}, nil)
				...
				// Second call during cleanup (remove is called by defer)
				mockSystemdMgr.EXPECT().ListDependencies(gomock.Any(), "app-vol-fail-flightctl.target").Return([]string{"app-vol-fail-app.service"}, nil)
				mockSystemdMgr.EXPECT().Stop(gomock.Any(), "app-vol-fail-flightctl.target").Return(nil).AnyTimes()
...
func TestQuadlet_remove(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			setupMocks: func(mockSystemdMgr *systemd.MockManager, mockRW *fileio.MockReadWriter, mockExec *executer.MockExecuter) {
				mockSystemdMgr.EXPECT().ListDependencies(gomock.Any(), "app-123-flightctl.target").Return([]string{"app-123-web.service"}, nil)
				mockSystemdMgr.EXPECT().Stop(gomock.Any(), "app-123-flightctl.target").Return(nil)
				...
				mockSystemdMgr.EXPECT().RemoveExclusions([]string{"app-123-web.service", "app-123-flightctl.target"})
		...
		},
		{
			...
			setupMocks: func(mockSystemdMgr *systemd.MockManager, mockRW *fileio.MockReadWriter, mockExec *executer.MockExecuter) {
				mockSystemdMgr.EXPECT().ListDependencies(gomock.Any(), "app-456-flightctl.target").Return(nil, fmt.Errorf("list dependencies failed"))
			},
			wantErr: true,
		},
		{
			...
			setupMocks: func(mockSystemdMgr *systemd.MockManager, mockRW *fileio.MockReadWriter, mockExec *executer.MockExecuter) {
				mockSystemdMgr.EXPECT().ListDependencies(gomock.Any(), "app-999-flightctl.target").Return([]string{"app-999-web.service"}, nil)
				mockSystemdMgr.EXPECT().Stop(gomock.Any(), "app-999-flightctl.target").Return(fmt.Errorf("stop failed"))
			},
			wantErr: true,
		},
		{
			...
			setupMocks: func(mockSystemdMgr *systemd.MockManager, mockRW *fileio.MockReadWriter, mockExec *executer.MockExecuter) {
				mockSystemdMgr.EXPECT().ListDependencies(gomock.Any(), "app-failed-1-flightctl.target").Return([]string{"app-failed-1-web.service"}, nil)
				mockSystemdMgr.EXPECT().Stop(gomock.Any(), "app-failed-1-flightctl.target").Return(nil)
		...
		},
		{
			...
			setupMocks: func(mockSystemdMgr *systemd.MockManager, mockRW *fileio.MockReadWriter, mockExec *executer.MockExecuter) {
				mockSystemdMgr.EXPECT().ListDependencies(gomock.Any(), "app-multi-flightctl.target").Return([]string{"app-multi-web.service", "app-multi-db.service"}, nil)
				mockSystemdMgr.EXPECT().Stop(gomock.Any(), "app-multi-flightctl.target").Return(nil)
		...
		},
		{
			...
			setupMocks: func(mockSystemdMgr *systemd.MockManager, mockRW *fileio.MockReadWriter, mockExec *executer.MockExecuter) {
				mockSystemdMgr.EXPECT().ListDependencies(gomock.Any(), "app-reset-fail-flightctl.target").Return([]string{"app-reset-fail-web.service"}, nil)
				mockSystemdMgr.EXPECT().Stop(gomock.Any(), "app-reset-fail-flightctl.target").Return(nil)
		...
		},
		{
			...
			setupMocks: func(mockSystemdMgr *systemd.MockManager, mockRW *fileio.MockReadWriter, mockExec *executer.MockExecuter) {
				mockSystemdMgr.EXPECT().ListDependencies(gomock.Any(), "app-list-fail-flightctl.target").Return([]string{"app-list-fail-web.service"}, nil)
				mockSystemdMgr.EXPECT().Stop(gomock.Any(), "app-list-fail-flightctl.target").Return(nil)
		...
		},
		{
			...
			setupMocks: func(mockSystemdMgr *systemd.MockManager, mockRW *fileio.MockReadWriter, mockExec *executer.MockExecuter) {
				mockSystemdMgr.EXPECT().ListDependencies(gomock.Any(), "app-with-artifact-vols-flightctl.target").Return([]string{"app-with-artifact-vols.service"}, nil)
				mockSystemdMgr.EXPECT().Stop(gomock.Any(), "app-with-artifact-vols-flightctl.target").Return(nil)
		...
		},
		{
			...
			setupMocks: func(mockSystemdMgr *systemd.MockManager, mockRW *fileio.MockReadWriter, mockExec *executer.MockExecuter) {
				mockSystemdMgr.EXPECT().ListDependencies(gomock.Any(), "app-mixed-vol-types-flightctl.target").Return([]string{"app-mixed-vol-types.service"}, nil)
				mockSystemdMgr.EXPECT().Stop(gomock.Any(), "app-mixed-vol-types-flightctl.target").Return(nil)
		...
		},
		{
			...
			setupMocks: func(mockSystemdMgr *systemd.MockManager, mockRW *fileio.MockReadWriter, mockExec *executer.MockExecuter) {
				mockSystemdMgr.EXPECT().ListDependencies(gomock.Any(), "app-cleanup-test-flightctl.target").Return([]string{}, nil)
				mockSystemdMgr.EXPECT().Stop(gomock.Any(), "app-cleanup-test-flightctl.target").Return(nil)
				mockExec.EXPECT().ExecuteWithContext(gomock.Any(), "podman", gomock.Any()).Return("[]", "", 0).AnyTimes()
			},
			setupServices: func(q *Quadlet) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			setupMocks: func(mockSystemdMgr *systemd.MockManager, mockRW *fileio.MockReadWriter, mockExec *executer.MockExecuter) {
				...
				mockSystemdMgr.EXPECT().ListDependencies(gomock.Any(), "app-123-flightctl.target").Return([]string{"app-123-app.service"}, nil).Times(2)
				mockSystemdMgr.EXPECT().Stop(gomock.Any(), "app-123-flightctl.target").Return(nil)
				...
				mockSystemdMgr.EXPECT().DaemonReload(gomock.Any()).Return(nil)
				mockSystemdMgr.EXPECT().Start(gomock.Any(), "app-123-flightctl.target").Return(nil)
			},
			setupServices: func(q *Quadlet) {
		...
		},
		{
			...
			setupMocks: func(mockSystemdMgr *systemd.MockManager, mockRW *fileio.MockReadWriter, mockExec *executer.MockExecuter) {
				mockSystemdMgr.EXPECT().ListDependencies(gomock.Any(), "app-456-flightctl.target").Return([]string{"app-456-app.service"}, nil)
				mockSystemdMgr.EXPECT().Stop(gomock.Any(), "app-456-flightctl.target").Return(fmt.Errorf("stop failed"))
			},
			setupServices: func(q *Quadlet) {
		...
		},
		{
			...
			setupMocks: func(mockSystemdMgr *systemd.MockManager, mockRW *fileio.MockReadWriter, mockExec *executer.MockExecuter) {
				mockSystemdMgr.EXPECT().ListDependencies(gomock.Any(), "app-789-flightctl.target").Return([]string{}, nil)
				mockSystemdMgr.EXPECT().Stop(gomock.Any(), "app-789-flightctl.target").Return(nil)
	...
	testCases := []struct {
	...
	}{
		{
			...
			setupMocks: func(mockSystemdMgr *systemd.MockManager, mockRW *fileio.MockReadWriter, mockExec *executer.MockExecuter) {
				...
				gomock.InOrder(
					mockSystemdMgr.EXPECT().ListDependencies(gomock.Any(), "app2-id-flightctl.target").Return([]string{"app2-id-web.service"}, nil),
					mockSystemdMgr.EXPECT().Stop(gomock.Any(), "app2-id-flightctl.target").Return(nil),
					mockSystemdMgr.EXPECT().Stop(gomock.Any(), "app2-id-web.service").Return(nil),
					...
					mockSystemdMgr.EXPECT().ListDependencies(gomock.Any(), "app3-id-flightctl.target").Return([]string{"app3-id-web.service"}, nil),
					mockSystemdMgr.EXPECT().Stop(gomock.Any(), "app3-id-flightctl.target").Return(nil),
					mockSystemdMgr.EXPECT().Stop(gomock.Any(), "app3-id-web.service").Return(nil),
					...
					mockSystemdMgr.EXPECT().ListDependencies(gomock.Any(), "app1-id-flightctl.target").Return([]string{"app1-id-app1.service"}, nil),
					...
					mockSystemdMgr.EXPECT().Start(gomock.Any(), "app1-id-flightctl.target").Return(nil),

					mockSystemdMgr.EXPECT().ListDependencies(gomock.Any(), "app3-id-flightctl.target").Return([]string{"app3-id-app3.service"}, nil),
					...
					mockSystemdMgr.EXPECT().Start(gomock.Any(), "app3-id-flightctl.target").Return(nil),
				)
			},
			setupServices: func(q *Quadlet) {
				q.actionCache.cache["app2-id"] = &actionCacheEntry{}
				q.actionCache.cache["app3-id"] = &actionCacheEntry{}
			},
			wantErr: false,
		},
		{
			...
			setupMocks: func(mockSystemdMgr *systemd.MockManager, mockRW *fileio.MockReadWriter, mockExec *executer.MockExecuter) {
				...
				gomock.InOrder(
					mockSystemdMgr.EXPECT().ListDependencies(gomock.Any(), "old1-id-flightctl.target").Return([]string{"old1-id-old1.service"}, nil),
					mockSystemdMgr.EXPECT().Stop(gomock.Any(), "old1-id-flightctl.target").Return(nil),
					mockSystemdMgr.EXPECT().Stop(gomock.Any(), "old1-id-old1.service").Return(nil),
					...
					mockSystemdMgr.EXPECT().ListDependencies(gomock.Any(), "old2-id-flightctl.target").Return([]string{"old2-id-old2.service"}, nil),
					mockSystemdMgr.EXPECT().Stop(gomock.Any(), "old2-id-flightctl.target").Return(nil),
					mockSystemdMgr.EXPECT().Stop(gomock.Any(), "old2-id-old2.service").Return(nil),
					...
					mockSystemdMgr.EXPECT().ListDependencies(gomock.Any(), "new1-id-flightctl.target").Return([]string{"new1-id-new1.service"}, nil),
					...
					mockSystemdMgr.EXPECT().Start(gomock.Any(), "new1-id-flightctl.target").Return(nil),

					mockSystemdMgr.EXPECT().ListDependencies(gomock.Any(), "new2-id-flightctl.target").Return([]string{"new2-id-new2.service"}, nil),
					...
					mockSystemdMgr.EXPECT().Start(gomock.Any(), "new2-id-flightctl.target").Return(nil),
				)
			},
			setupServices: func(q *Quadlet) {
				q.actionCache.cache["old1-id"] = &actionCacheEntry{}
				q.actionCache.cache["old2-id"] = &actionCacheEntry{}
			},
			wantErr: false,
		},
		{
			...
			setupMocks: func(mockSystemdMgr *systemd.MockManager, mockRW *fileio.MockReadWriter, mockExec *executer.MockExecuter) {
				mockSystemdMgr.EXPECT().ListDependencies(gomock.Any(), "app1-id-flightctl.target").Return([]string{"app1-id-app1.service"}, nil)
				mockSystemdMgr.EXPECT().Stop(gomock.Any(), "app1-id-flightctl.target").Return(fmt.Errorf("stop failed"))
			},
			setupServices: func(q *Quadlet) {
				q.actionCache.cache["app1-id"] = &actionCacheEntry{}
			},
			wantErr: true,
		},
		{
			...
			setupMocks: func(mockSystemdMgr *systemd.MockManager, mockRW *fileio.MockReadWriter, mockExec *executer.MockExecuter) {
				...
				gomock.InOrder(
					mockSystemdMgr.EXPECT().ListDependencies(gomock.Any(), "app1-id-flightctl.target").Return([]string{"app1-id-app1.service"}, nil),
					mockSystemdMgr.EXPECT().Stop(gomock.Any(), "app1-id-flightctl.target").Return(nil),
					mockSystemdMgr.EXPECT().Stop(gomock.Any(), "app1-id-app1.service").Return(nil),
