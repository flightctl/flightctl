...
func TestUpdateContainerHealthStatus(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name:                   "When VM desiredState is stopped it should ignore health_status and keep Stopping while still running",
			appType:                v1beta1.AppTypeVm,
		...
		{
			name:                   "When VM desiredState is stopped it should ignore healthy health_status too",
			appType:                v1beta1.AppTypeVm,
			desiredState:           v1beta1.ApplicationDesiredStateStopped,
			initialWorkloadStatus:  StatusRunning,
			health:                 "healthy",
