...
//
//	mockgen -source=status.go -destination=mock_status.go -package=status
//
...
func (m *MockExporter) Status(arg0 context.Context, arg1 *api.DeviceStatus, arg2 ...CollectorOpt) error {
	m.ctrl.T.Helper()
...
func (m *MockGetter) Get(arg0 context.Context) *api.DeviceStatus {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", arg0)
	ret0, _ := ret[0].(*api.DeviceStatus)
	return ret0
}
...
// Get mocks base method.
func (m *MockManager) Get(arg0 context.Context) *api.DeviceStatus {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", arg0)
	ret0, _ := ret[0].(*api.DeviceStatus)
	return ret0
...
func (m *MockManager) Update(ctx context.Context, updateFuncs ...UpdateStatusFn) (*api.DeviceStatus, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx}
...
func (m *MockManager) UpdateCondition(arg0 context.Context, arg1 api.Condition) error {
	m.ctrl.T.Helper()
