...
func TestSync(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			consoleController := console.NewController(mockRouterService, deviceName, mockExec, device_publisher.NewSubscription(), log)
			...
			devicePublisher := device_publisher.NewSubscription()
