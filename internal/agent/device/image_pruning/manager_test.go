...
func TestManager_getImageReferencesFromSpecs(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			want: []ImageRef{
				{Owner: v1beta1.DefaultApplicationUsername, Image: "quay.io/example/app:current", Type: RefTypePodman},
				{Owner: v1beta1.DefaultApplicationUsername, Image: "quay.io/example/app:desired", Type: RefTypePodman},
			},
		},
		{
			...
			want: []ImageRef{{Owner: v1beta1.DefaultApplicationUsername, Image: "quay.io/example/app:current", Type: RefTypePodman}},
		},
		{
