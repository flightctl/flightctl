...
// Source: api/grpc/v1/router_grpc.pb.go
//
// Generated by this command:
//
//	mockgen -source=api/grpc/v1/router_grpc.pb.go -destination=internal/agent/device/console/mock_router_service_client.go -package=console
//
