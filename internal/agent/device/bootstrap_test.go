...
func TestInitialization(t *testing.T) {
	...
	testCases := []struct {
		...
		setupMocks func(
			...
			mockDevicePublisher *device_publisher.MockDevicePublisher,
	...
	}{
		{
			...
			setupMocks: func(
				...
				gomock.InOrder(
					...
					mockDevicePublisher.EXPECT().SetClient(gomock.Any()),
	...
	for _, tt := range testCases {
		t.Run(tt.name, func(t *testing.T) {
			...
			mockDevicePublisher := device_publisher.NewMockDevicePublisher(ctrl)
			...
			b := &Bootstrap{
				...
				devicePublisher:         mockDevicePublisher,
