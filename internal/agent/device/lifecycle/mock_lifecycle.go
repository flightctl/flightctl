...
func (m *MockManager) AfterUpdate(ctx context.Context, current, desired *v1beta1.DeviceSpec) error {
	m.ctrl.T.Helper()
...
func (m *MockManager) Sync(ctx context.Context, current, desired *v1beta1.DeviceSpec) error {
	m.ctrl.T.Helper()
...
func (m *MockInitializer) Initialize(ctx context.Context, status *v1beta1.DeviceStatus) error {
	m.ctrl.T.Helper()
