...
func (c *Controller) verifyDeviceEnrollment(ctx context.Context, device *v1alpha1.Device) (bool, error) {
...
func (c *Controller) writeQRBanner(message, url string) error {
...
func (c *Controller) deviceEnrollmentRequest(ctx context.Context, device *v1alpha1.Device) error {
