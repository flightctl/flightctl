...
func (m *MockManagerNoClient) Read(specType SpecType) (*v1alpha1.RenderedDeviceSpec, error) {
	m.ctrl.T.Helper()
...
func (m *MockManagerNoClient) Write(specType SpecType, rendered *v1alpha1.RenderedDeviceSpec) error {
	m.ctrl.T.Helper()
...
// Read mocks base method.
func (m *MockManager) Read(specType SpecType) (*v1alpha1.RenderedDeviceSpec, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Read", specType)
	ret0, _ := ret[0].(*v1alpha1.RenderedDeviceSpec)
	ret1, _ := ret[1].(error)
...
// Write mocks base method.
func (m *MockManager) Write(specType SpecType, rendered *v1alpha1.RenderedDeviceSpec) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Write", specType, rendered)
	ret0, _ := ret[0].(error)
	return ret0
