...
//
//	mockgen -source=spec.go -destination=spec/mock_spec.go -package=spec
//
...
import (
	...
	spec "github.com/flightctl/flightctl/internal/agent/device/spec"
...
func (m *MockManager) OSVersion(specType spec.Type) string {
	m.ctrl.T.Helper()
...
func (m *MockManager) Read(specType spec.Type) (*v1alpha1.RenderedDeviceSpec, error) {
	m.ctrl.T.Helper()
...
func (m *MockManager) RenderedVersion(specType spec.Type) string {
	m.ctrl.T.Helper()
...
func (m *MockPriorityQueue) Add(item *spec.Item) error {
	m.ctrl.T.Helper()
...
func (m *MockPriorityQueue) Next() (*spec.Item, bool) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Next")
	ret0, _ := ret[0].(*spec.Item)
	ret1, _ := ret[1].(bool)
	return ret0, ret1
}
