...
func (b *Bootstrap) ensureBootstrap(ctx context.Context) error {
	desiredSpec, err := b.specManager.Read(spec.TypeDesired)
	if err != nil {
		return err
	}
	...
	if err := b.specManager.Write(spec.TypeCurrent, desiredSpec); err != nil {
