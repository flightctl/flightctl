...
// Source: internal/agent/identity/identity.go
//
// Generated by this command:
//
//	mockgen -source=internal/agent/identity/identity.go -destination=internal/agent/identity/mock_identity.go -package=identity
//
...
func (m *MockProvider) CreateManagementClient(config *client0.Config, metricsCallback client.RPCMetricsCallback, deviceNotFoundCallback client.DeviceNotFoundCallback) (client.Management, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateManagementClient", config, metricsCallback, deviceNotFoundCallback)
...
func (mr *MockProviderMockRecorder) CreateManagementClient(config, metricsCallback, deviceNotFoundCallback any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateManagementClient", reflect.TypeOf((*MockProvider)(nil).CreateManagementClient), config, metricsCallback, deviceNotFoundCallback)
}
...
// WipeCertificate mocks base method.
func (m *MockProvider) WipeCertificate() error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WipeCertificate")
	ret0, _ := ret[0].(error)
	return ret0
}

// WipeCertificate indicates an expected call of WipeCertificate.
func (mr *MockProviderMockRecorder) WipeCertificate() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WipeCertificate", reflect.TypeOf((*MockProvider)(nil).WipeCertificate))
}
