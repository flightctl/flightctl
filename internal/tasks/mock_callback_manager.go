...
// Source: internal/tasks/callback_manager.go
//
// Generated by this command:
//
//	mockgen -source=internal/tasks/callback_manager.go -destination=internal/tasks/mock_callback_manager.go -package=tasks
//
