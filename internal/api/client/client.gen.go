...
type ClientInterface interface {
	...
	// GetSosReport request
	GetSosReport(ctx context.Context, name string, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) GetSosReport(ctx context.Context, name string, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetSosReportRequest(c.Server, name)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewGetSosReportRequest generates requests for GetSosReport
func NewGetSosReportRequest(server string, name string) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/api/v1/devices/%s/sosreport", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	...
	// GetSosReportWithResponse request
	GetSosReportWithResponse(ctx context.Context, name string, reqEditors ...RequestEditorFn) (*GetSosReportResponse, error)
...
type GetSosReportResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON400      *Status
	JSON401      *Status
...
// Status returns HTTPResponse.Status
func (r GetSosReportResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r GetSosReportResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// GetSosReportWithResponse request returning *GetSosReportResponse
func (c *ClientWithResponses) GetSosReportWithResponse(ctx context.Context, name string, reqEditors ...RequestEditorFn) (*GetSosReportResponse, error) {
	rsp, err := c.GetSosReport(ctx, name, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseGetSosReportResponse(rsp)
}
...
// ParseGetSosReportResponse parses an HTTP response from a GetSosReportWithResponse call
func ParseGetSosReportResponse(rsp *http.Response) (*GetSosReportResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
