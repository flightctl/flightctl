...
type ClientInterface interface {
	...
	TokenValidate(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error)
}
...
func (c *Client) TokenValidate(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewTokenValidateRequest(c.Server)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func NewTokenValidateRequest(server string) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	...
	TokenValidateWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*TokenValidateResponse, error)
}
...
func (c *ClientWithResponses) TokenValidateWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*TokenValidateResponse, error) {
	rsp, err := c.TokenValidate(ctx, reqEditors...)
	if err != nil {
		return nil, err
	}
