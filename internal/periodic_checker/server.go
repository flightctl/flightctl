...
func (s *Server) Run() error {
	...
	disruptionAllowanceThread := thread.New(
		s.log.WithField("pkg", "disruption-allowance"), "Disruption allowance", disruption_allowance.DisruptionAllowanceReconcilationInterval, func() { disruptionAllowance.Reconcile(ctx) })
