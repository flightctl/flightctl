...
func (s *Server) Run(ctx context.Context) error {
	...
	deltaPrepareSvc := deltaprepare.WrapWithTracing(deltaprepare.NewServiceHandler(deltaStore, nil))
	periodicTaskExecutors := InitializeTaskExecutors(s.log,
		...
		s.cfg, queuesProvider, workerClient, nil, findingSvc, scanner, depSyncMetrics, deltaStore, deltaPrepareSvc, tvSvc)
