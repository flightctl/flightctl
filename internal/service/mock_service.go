...
func (m *MockService) ApproveEnrollmentRequest(ctx context.Context, orgId uuid.UUID, name string, approval api.EnrollmentRequestApproval) (*api.EnrollmentRequestApprovalStatus, api.Status) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ApproveEnrollmentRequest", ctx, orgId, name, approval)
	ret0, _ := ret[0].(*api.EnrollmentRequestApprovalStatus)
	ret1, _ := ret[1].(api.Status)
	return ret0, ret1
}
...
func (m *MockService) CountDevices(ctx context.Context, orgId uuid.UUID, params api.ListDevicesParams, annotationSelector *selector.AnnotationSelector) (int64, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) CountDevicesByLabels(ctx context.Context, orgId uuid.UUID, params api.ListDevicesParams, annotationSelector *selector.AnnotationSelector, groupBy []string) ([]map[string]any, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) CreateAuthProvider(ctx context.Context, orgId uuid.UUID, authProvider api.AuthProvider) (*api.AuthProvider, api.Status) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateAuthProvider", ctx, orgId, authProvider)
	ret0, _ := ret[0].(*api.AuthProvider)
	ret1, _ := ret[1].(api.Status)
	return ret0, ret1
}
...
func (m *MockService) CreateCertificateSigningRequest(ctx context.Context, orgId uuid.UUID, csr api.CertificateSigningRequest) (*api.CertificateSigningRequest, api.Status) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateCertificateSigningRequest", ctx, orgId, csr)
	ret0, _ := ret[0].(*api.CertificateSigningRequest)
	ret1, _ := ret[1].(api.Status)
	return ret0, ret1
}
...
func (m *MockService) CreateDevice(ctx context.Context, orgId uuid.UUID, device api.Device) (*api.Device, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) CreateEnrollmentRequest(ctx context.Context, orgId uuid.UUID, er api.EnrollmentRequest) (*api.EnrollmentRequest, api.Status) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateEnrollmentRequest", ctx, orgId, er)
	ret0, _ := ret[0].(*api.EnrollmentRequest)
	ret1, _ := ret[1].(api.Status)
	return ret0, ret1
}
...
func (m *MockService) CreateEvent(ctx context.Context, orgId uuid.UUID, event *api.Event) {
	m.ctrl.T.Helper()
...
func (m *MockService) CreateFleet(ctx context.Context, orgId uuid.UUID, fleet api.Fleet) (*api.Fleet, api.Status) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateFleet", ctx, orgId, fleet)
	ret0, _ := ret[0].(*api.Fleet)
	ret1, _ := ret[1].(api.Status)
	return ret0, ret1
}
...
func (m *MockService) CreateRepository(ctx context.Context, orgId uuid.UUID, repo api.Repository) (*api.Repository, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) CreateResourceSync(ctx context.Context, orgId uuid.UUID, rs api.ResourceSync) (*api.ResourceSync, api.Status) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateResourceSync", ctx, orgId, rs)
	ret0, _ := ret[0].(*api.ResourceSync)
	ret1, _ := ret[1].(api.Status)
	return ret0, ret1
}
...
func (m *MockService) CreateTemplateVersion(ctx context.Context, orgId uuid.UUID, tv api.TemplateVersion, immediateRollout bool) (*api.TemplateVersion, api.Status) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateTemplateVersion", ctx, orgId, tv, immediateRollout)
	ret0, _ := ret[0].(*api.TemplateVersion)
	ret1, _ := ret[1].(api.Status)
	return ret0, ret1
}
...
func (m *MockService) DecommissionDevice(ctx context.Context, orgId uuid.UUID, name string, decom api.DeviceDecommission) (*api.Device, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) DeleteAuthProvider(ctx context.Context, orgId uuid.UUID, name string) api.Status {
	m.ctrl.T.Helper()
...
func (m *MockService) DeleteCertificateSigningRequest(ctx context.Context, orgId uuid.UUID, name string) api.Status {
	m.ctrl.T.Helper()
...
func (m *MockService) DeleteDevice(ctx context.Context, orgId uuid.UUID, name string) api.Status {
	m.ctrl.T.Helper()
...
func (m *MockService) DeleteEnrollmentRequest(ctx context.Context, orgId uuid.UUID, name string) api.Status {
	m.ctrl.T.Helper()
...
func (m *MockService) DeleteEventsOlderThan(ctx context.Context, cutoffTime time.Time) (int64, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) DeleteFleet(ctx context.Context, orgId uuid.UUID, name string) api.Status {
	m.ctrl.T.Helper()
...
func (m *MockService) DeleteRepository(ctx context.Context, orgId uuid.UUID, name string) api.Status {
	m.ctrl.T.Helper()
...
func (m *MockService) DeleteResourceSync(ctx context.Context, orgId uuid.UUID, name string) api.Status {
	m.ctrl.T.Helper()
...
func (m *MockService) DeleteTemplateVersion(ctx context.Context, orgId uuid.UUID, fleet, name string) api.Status {
	m.ctrl.T.Helper()
...
func (m *MockService) GetAuthConfig(ctx context.Context, authConfig *api.AuthConfig) (*api.AuthConfig, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) GetAuthProvider(ctx context.Context, orgId uuid.UUID, name string) (*api.AuthProvider, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) GetAuthProviderByAuthorizationUrl(ctx context.Context, orgId uuid.UUID, authorizationUrl string) (*api.AuthProvider, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) GetAuthProviderByIssuerAndClientId(ctx context.Context, orgId uuid.UUID, issuer, clientId string) (*api.AuthProvider, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) GetCertificateSigningRequest(ctx context.Context, orgId uuid.UUID, name string) (*api.CertificateSigningRequest, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) GetCheckpoint(ctx context.Context, consumer, key string) ([]byte, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) GetDatabaseTime(ctx context.Context) (time.Time, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) GetDevice(ctx context.Context, orgId uuid.UUID, name string) (*api.Device, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) GetDeviceCompletionCounts(ctx context.Context, orgId uuid.UUID, owner, templateVersion string, updateTimeout *time.Duration) ([]api.DeviceCompletionCount, api.Status) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetDeviceCompletionCounts", ctx, orgId, owner, templateVersion, updateTimeout)
	ret0, _ := ret[0].([]api.DeviceCompletionCount)
	ret1, _ := ret[1].(api.Status)
	return ret0, ret1
}
...
func (m *MockService) GetDeviceLastSeen(ctx context.Context, orgId uuid.UUID, name string) (*api.DeviceLastSeen, api.Status) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetDeviceLastSeen", ctx, orgId, name)
	ret0, _ := ret[0].(*api.DeviceLastSeen)
	ret1, _ := ret[1].(api.Status)
	return ret0, ret1
}
...
func (m *MockService) GetDeviceRepositoryRefs(ctx context.Context, orgId uuid.UUID, name string) (*api.RepositoryList, api.Status) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetDeviceRepositoryRefs", ctx, orgId, name)
	ret0, _ := ret[0].(*api.RepositoryList)
	ret1, _ := ret[1].(api.Status)
	return ret0, ret1
}
...
func (m *MockService) GetDeviceStatus(ctx context.Context, orgId uuid.UUID, name string) (*api.Device, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) GetDevicesSummary(ctx context.Context, orgId uuid.UUID, params api.ListDevicesParams, annotationSelector *selector.AnnotationSelector) (*api.DevicesSummary, api.Status) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetDevicesSummary", ctx, orgId, params, annotationSelector)
	ret0, _ := ret[0].(*api.DevicesSummary)
	ret1, _ := ret[1].(api.Status)
	return ret0, ret1
}
...
func (m *MockService) GetEnrollmentConfig(ctx context.Context, orgId uuid.UUID, params api.GetEnrollmentConfigParams) (*api.EnrollmentConfig, api.Status) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetEnrollmentConfig", ctx, orgId, params)
	ret0, _ := ret[0].(*api.EnrollmentConfig)
	ret1, _ := ret[1].(api.Status)
	return ret0, ret1
}
...
func (m *MockService) GetEnrollmentRequest(ctx context.Context, orgId uuid.UUID, name string) (*api.EnrollmentRequest, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) GetEnrollmentRequestStatus(ctx context.Context, orgId uuid.UUID, name string) (*api.EnrollmentRequest, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) GetFleet(ctx context.Context, orgId uuid.UUID, name string, params api.GetFleetParams) (*api.Fleet, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) GetFleetRepositoryRefs(ctx context.Context, orgId uuid.UUID, name string) (*api.RepositoryList, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) GetFleetStatus(ctx context.Context, orgId uuid.UUID, name string) (*api.Fleet, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) GetLatestTemplateVersion(ctx context.Context, orgId uuid.UUID, fleet string) (*api.TemplateVersion, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) GetRenderedDevice(ctx context.Context, orgId uuid.UUID, name string, params api.GetRenderedDeviceParams) (*api.Device, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) GetRepository(ctx context.Context, orgId uuid.UUID, name string) (*api.Repository, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) GetRepositoryDeviceReferences(ctx context.Context, orgId uuid.UUID, name string) (*api.DeviceList, api.Status) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRepositoryDeviceReferences", ctx, orgId, name)
	ret0, _ := ret[0].(*api.DeviceList)
	ret1, _ := ret[1].(api.Status)
	return ret0, ret1
}
...
func (m *MockService) GetRepositoryFleetReferences(ctx context.Context, orgId uuid.UUID, name string) (*api.FleetList, api.Status) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRepositoryFleetReferences", ctx, orgId, name)
	ret0, _ := ret[0].(*api.FleetList)
	ret1, _ := ret[1].(api.Status)
	return ret0, ret1
}
...
func (m *MockService) GetResourceSync(ctx context.Context, orgId uuid.UUID, name string) (*api.ResourceSync, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) GetTemplateVersion(ctx context.Context, orgId uuid.UUID, fleet, name string) (*api.TemplateVersion, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) ListAuthProviders(ctx context.Context, orgId uuid.UUID, params api.ListAuthProvidersParams) (*api.AuthProviderList, api.Status) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListAuthProviders", ctx, orgId, params)
	ret0, _ := ret[0].(*api.AuthProviderList)
	ret1, _ := ret[1].(api.Status)
	return ret0, ret1
}
...
func (m *MockService) ListCertificateSigningRequests(ctx context.Context, orgId uuid.UUID, params api.ListCertificateSigningRequestsParams) (*api.CertificateSigningRequestList, api.Status) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListCertificateSigningRequests", ctx, orgId, params)
	ret0, _ := ret[0].(*api.CertificateSigningRequestList)
	ret1, _ := ret[1].(api.Status)
	return ret0, ret1
}
...
func (m *MockService) ListDevices(ctx context.Context, orgId uuid.UUID, params api.ListDevicesParams, annotationSelector *selector.AnnotationSelector) (*api.DeviceList, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) ListDevicesByServiceCondition(ctx context.Context, orgId uuid.UUID, conditionType, conditionStatus string, listParams store.ListParams) (*api.DeviceList, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) ListDisconnectedDevices(ctx context.Context, orgId uuid.UUID, params api.ListDevicesParams, cutoffTime time.Time) (*api.DeviceList, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) ListDisruptionBudgetFleets(ctx context.Context, orgId uuid.UUID) (*api.FleetList, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) ListEnrollmentRequests(ctx context.Context, orgId uuid.UUID, params api.ListEnrollmentRequestsParams) (*api.EnrollmentRequestList, api.Status) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListEnrollmentRequests", ctx, orgId, params)
	ret0, _ := ret[0].(*api.EnrollmentRequestList)
	ret1, _ := ret[1].(api.Status)
	return ret0, ret1
}
...
func (m *MockService) ListEvents(ctx context.Context, orgId uuid.UUID, params api.ListEventsParams) (*api.EventList, api.Status) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListEvents", ctx, orgId, params)
	ret0, _ := ret[0].(*api.EventList)
	ret1, _ := ret[1].(api.Status)
	return ret0, ret1
}
...
func (m *MockService) ListFleetRolloutDeviceSelection(ctx context.Context, orgId uuid.UUID) (*api.FleetList, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) ListFleets(ctx context.Context, orgId uuid.UUID, params api.ListFleetsParams) (*api.FleetList, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) ListLabels(ctx context.Context, orgId uuid.UUID, params api.ListLabelsParams) (*api.LabelList, api.Status) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListLabels", ctx, orgId, params)
	ret0, _ := ret[0].(*api.LabelList)
	ret1, _ := ret[1].(api.Status)
	return ret0, ret1
}
...
func (m *MockService) ListOrganizations(ctx context.Context, params api.ListOrganizationsParams) (*api.OrganizationList, api.Status) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListOrganizations", ctx, params)
	ret0, _ := ret[0].(*api.OrganizationList)
	ret1, _ := ret[1].(api.Status)
	return ret0, ret1
}
...
func (m *MockService) ListRepositories(ctx context.Context, orgId uuid.UUID, params api.ListRepositoriesParams) (*api.RepositoryList, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) ListResourceSyncs(ctx context.Context, orgId uuid.UUID, params api.ListResourceSyncsParams) (*api.ResourceSyncList, api.Status) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListResourceSyncs", ctx, orgId, params)
	ret0, _ := ret[0].(*api.ResourceSyncList)
	ret1, _ := ret[1].(api.Status)
	return ret0, ret1
}
...
func (m *MockService) ListTemplateVersions(ctx context.Context, orgId uuid.UUID, fleet string, params api.ListTemplateVersionsParams) (*api.TemplateVersionList, api.Status) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListTemplateVersions", ctx, orgId, fleet, params)
	ret0, _ := ret[0].(*api.TemplateVersionList)
	ret1, _ := ret[1].(api.Status)
	return ret0, ret1
}
...
func (m *MockService) MarkDevicesRolloutSelection(ctx context.Context, orgId uuid.UUID, params api.ListDevicesParams, annotationSelector *selector.AnnotationSelector, limit *int) api.Status {
	m.ctrl.T.Helper()
...
func (m *MockService) OverwriteDeviceRepositoryRefs(ctx context.Context, orgId uuid.UUID, name string, repositoryNames ...string) api.Status {
	m.ctrl.T.Helper()
...
func (m *MockService) OverwriteFleetRepositoryRefs(ctx context.Context, orgId uuid.UUID, name string, repositoryNames ...string) api.Status {
	m.ctrl.T.Helper()
	varargs := []any{ctx, orgId, name}
	for _, a := range repositoryNames {
		varargs = append(varargs, a)
...
func (m *MockService) PatchAuthProvider(ctx context.Context, orgId uuid.UUID, name string, patch api.PatchRequest) (*api.AuthProvider, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) PatchCertificateSigningRequest(ctx context.Context, orgId uuid.UUID, name string, patch api.PatchRequest) (*api.CertificateSigningRequest, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) PatchDevice(ctx context.Context, orgId uuid.UUID, name string, patch api.PatchRequest) (*api.Device, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) PatchDeviceStatus(ctx context.Context, orgId uuid.UUID, name string, patch api.PatchRequest) (*api.Device, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) PatchEnrollmentRequest(ctx context.Context, orgId uuid.UUID, name string, patch api.PatchRequest) (*api.EnrollmentRequest, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) PatchFleet(ctx context.Context, orgId uuid.UUID, name string, patch api.PatchRequest) (*api.Fleet, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) PatchRepository(ctx context.Context, orgId uuid.UUID, name string, patch api.PatchRequest) (*api.Repository, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) PatchResourceSync(ctx context.Context, orgId uuid.UUID, name string, patch api.PatchRequest) (*api.ResourceSync, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) ReplaceAuthProvider(ctx context.Context, orgId uuid.UUID, name string, authProvider api.AuthProvider) (*api.AuthProvider, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) ReplaceCertificateSigningRequest(ctx context.Context, orgId uuid.UUID, name string, csr api.CertificateSigningRequest) (*api.CertificateSigningRequest, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) ReplaceDevice(ctx context.Context, orgId uuid.UUID, name string, device api.Device, fieldsToUnset []string) (*api.Device, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) ReplaceDeviceStatus(ctx context.Context, orgId uuid.UUID, name string, device api.Device) (*api.Device, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) ReplaceEnrollmentRequest(ctx context.Context, orgId uuid.UUID, name string, er api.EnrollmentRequest) (*api.EnrollmentRequest, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) ReplaceEnrollmentRequestStatus(ctx context.Context, orgId uuid.UUID, name string, er api.EnrollmentRequest) (*api.EnrollmentRequest, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) ReplaceFleet(ctx context.Context, orgId uuid.UUID, name string, fleet api.Fleet) (*api.Fleet, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) ReplaceFleetStatus(ctx context.Context, orgId uuid.UUID, name string, fleet api.Fleet) (*api.Fleet, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) ReplaceRepository(ctx context.Context, orgId uuid.UUID, name string, repo api.Repository) (*api.Repository, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) ReplaceRepositoryStatusByError(ctx context.Context, orgId uuid.UUID, name string, repository api.Repository, err error) (*api.Repository, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) ReplaceResourceSync(ctx context.Context, orgId uuid.UUID, name string, rs api.ResourceSync) (*api.ResourceSync, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) ReplaceResourceSyncStatus(ctx context.Context, orgId uuid.UUID, name string, resourceSync api.ResourceSync) (*api.ResourceSync, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) ResumeDevices(ctx context.Context, orgId uuid.UUID, request api.DeviceResumeRequest) (api.DeviceResumeResponse, api.Status) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ResumeDevices", ctx, orgId, request)
	ret0, _ := ret[0].(api.DeviceResumeResponse)
	ret1, _ := ret[1].(api.Status)
	return ret0, ret1
}
...
func (m *MockService) SetCheckpoint(ctx context.Context, consumer, key string, value []byte) api.Status {
	m.ctrl.T.Helper()
...
func (m *MockService) SetDeviceServiceConditions(ctx context.Context, orgId uuid.UUID, name string, conditions []api.Condition) api.Status {
	m.ctrl.T.Helper()
...
func (m *MockService) UnmarkDevicesRolloutSelection(ctx context.Context, orgId uuid.UUID, fleetName string) api.Status {
	m.ctrl.T.Helper()
...
func (m *MockService) UpdateCertificateSigningRequestApproval(ctx context.Context, orgId uuid.UUID, name string, csr api.CertificateSigningRequest) (*api.CertificateSigningRequest, api.Status) {
	m.ctrl.T.Helper()
...
func (m *MockService) UpdateDevice(ctx context.Context, orgId uuid.UUID, name string, device api.Device, fieldsToUnset []string) (*api.Device, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) UpdateDeviceAnnotations(ctx context.Context, orgId uuid.UUID, name string, annotations map[string]string, deleteKeys []string) api.Status {
	m.ctrl.T.Helper()
...
func (m *MockService) UpdateFleetAnnotations(ctx context.Context, orgId uuid.UUID, name string, annotations map[string]string, deleteKeys []string) api.Status {
	m.ctrl.T.Helper()
...
func (m *MockService) UpdateFleetConditions(ctx context.Context, orgId uuid.UUID, name string, conditions []api.Condition) api.Status {
	m.ctrl.T.Helper()
...
func (m *MockService) UpdateRenderedDevice(ctx context.Context, orgId uuid.UUID, name, renderedConfig, renderedApplications, specHash string) api.Status {
	m.ctrl.T.Helper()
...
func (m *MockService) UpdateServiceSideDeviceStatus(ctx context.Context, orgId uuid.UUID, device api.Device) bool {
	m.ctrl.T.Helper()
