...
func NewServiceHandler(store store.Store, callbackManager tasks.CallbackManager, configStorage tasks.ConfigStorage, ca *crypto.CA, log logrus.FieldLogger, agentEndpoint string, uiUrl string) *ServiceHandler {
