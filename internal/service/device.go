...
func (h *ServiceHandler) diffAndEmitConditionEvents(ctx context.Context, orgId uuid.UUID, device *domain.Device, oldConditions, newConditions []domain.Condition) {
	...
	oldBootcTimerCondition := domain.FindStatusCondition(oldConditions, domain.ConditionTypeDeviceBootcTimerCompliant)
	newBootcTimerCondition := domain.FindStatusCondition(newConditions, domain.ConditionTypeDeviceBootcTimerCompliant)
