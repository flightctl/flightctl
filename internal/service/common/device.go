...
func updateServerSideDeviceStatus(device, oldDevice *api.Device) (bool, ResourceUpdates) {
	...
	if oldDevice != nil && oldDevice.Status != nil {
		allDevicesWereUnknown = oldDevice.Status.Resources.Cpu == api.DeviceResourceStatusUnknown &&
			oldDevice.Status.Resources.Memory == api.DeviceResourceStatusUnknown &&
			oldDevice.Status.Resources.Disk == api.DeviceResourceStatusUnknown
