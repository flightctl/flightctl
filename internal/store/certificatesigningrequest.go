...
type CertificateSigningRequestStore struct {
	...
	genericStore *GenericStore[*model.CertificateSigningRequest, model.CertificateSigningRequest, api.CertificateSigningRequest, *model.CertificateSigningRequestList, api.CertificateSigningRequestList]
}
...
func NewCertificateSigningRequest(db *gorm.DB, log logrus.FieldLogger) CertificateSigningRequest {
	genericStore := NewGenericStore[*model.CertificateSigningRequest, model.CertificateSigningRequest, api.CertificateSigningRequest, *model.CertificateSigningRequestList, api.CertificateSigningRequestList](
		db,
		log,
		model.NewCertificateSigningRequestFromApiResource,
		(*model.CertificateSigningRequest).ToApiResource,
		(*model.CertificateSigningRequestList).ToApiResource,
		model.CertificateSigningRequestPtrToCertificateSigningRequest,
		model.CertificateSigningRequestPtrToCertificateSigningRequest,
	)
...
func (s *CertificateSigningRequestStore) Update(ctx context.Context, orgId uuid.UUID, resource *api.CertificateSigningRequest) (*api.CertificateSigningRequest, error) {
	return s.genericStore.Update(ctx, orgId, resource, nil, true, nil)
}
...
func (s *CertificateSigningRequestStore) CreateOrUpdate(ctx context.Context, orgId uuid.UUID, resource *api.CertificateSigningRequest) (*api.CertificateSigningRequest, bool, error) {
	return s.genericStore.CreateOrUpdate(ctx, orgId, resource, nil, true, nil)
}
