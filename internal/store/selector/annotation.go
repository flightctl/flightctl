...
// NewAnnotationSelectorFromMapOrDie creates a AnnotationSelector from a map of annotations
...
// NewAnnotationSelectorFromMap creates a AnnotationSelector from a map of annotations
...
// NewAnnotationSelectorOrDie creates a AnnotationSelector from a string using Kubernetes-style
...
// NewAnnotationSelector creates a AnnotationSelector from a string using Kubernetes-style
...
func NewAnnotationSelector(input string) (*AnnotationSelector, error) {
	// Use the generic parser without any validation specific to annotations.
	// This package only provides validation for fields and labes.
	// Annotation keys will be validated later during the resolution process.
	selector, err := selector.Parse(input)
	if err != nil {
