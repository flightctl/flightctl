...
type EnrollmentRequestStore struct {
	...
	genericStore *GenericStore[*model.EnrollmentRequest, model.EnrollmentRequest, api.EnrollmentRequest, *model.EnrollmentRequestList, api.EnrollmentRequestList]
}
...
func NewEnrollmentRequest(db *gorm.DB, log logrus.FieldLogger) EnrollmentRequest {
	genericStore := NewGenericStore[*model.EnrollmentRequest, model.EnrollmentRequest, api.EnrollmentRequest, *model.EnrollmentRequestList, api.EnrollmentRequestList](
		db,
		log,
		model.NewEnrollmentRequestFromApiResource,
		(*model.EnrollmentRequest).ToApiResource,
		(*model.EnrollmentRequestList).ToApiResource,
		model.EnrollmentRequestPtrReturnSelf,
		model.EnrollmentRequestPtrReturnSelf,
	)
