...
// TestNewEnrollmentRequestStore_ReturnsNonNilStore proves the constructor
...
func TestNewEnrollmentRequestStore_ReturnsNonNilStore(t *testing.T) {
	req := require.New(t)

	s := NewEnrollmentRequestStore(nil, logrus.New())
