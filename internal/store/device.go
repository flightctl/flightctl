...
type Device interface {
	...
	UpdateToOutOfDateByOwner(ctx context.Context, orgId uuid.UUID, owner string) error
...
func (s *DeviceStore) updateToOutOfDateByOwner(ctx context.Context, orgId uuid.UUID, owner string) (bool, error) {
...
func (s *DeviceStore) UpdateToOutOfDateByOwner(ctx context.Context, orgId uuid.UUID, owner string) error {
	return retryUpdate(func() (bool, error) {
		return s.updateToOutOfDateByOwner(ctx, orgId, owner)
	})
}
