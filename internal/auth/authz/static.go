...
var resourcePermissions = map[string]map[string][]string{
	...
	v1beta1.RoleOperator: {
		...
		"devices/enrollmenthooks/override": {"update"},      // ManualOverride a failed enrollment hook
	...
	v1beta1.RoleViewer: {
		...
		"devices/enrollmenthooks/override": {},              // Explicitly denied - ManualOverride requires operator or admin role
	},
