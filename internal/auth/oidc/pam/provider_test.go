...
var _ = Describe("Login Form Branding", func() {
	...
	Context("Light theme color overrides", func() {
		It("should inject CSS variable overrides in :root scope", func() {
			...
			rawHTML := provider.GetLoginForm()
			Expect(rawHTML).To(ContainSubstring("--pf-t--global--color--brand--default: #0066cc"))
			Expect(rawHTML).To(ContainSubstring("--pf-t--global--color--brand--hover: #004499"))
			Expect(rawHTML).To(ContainSubstring("--pf-t--global--color--brand--clicked: #004499"))
			Expect(rawHTML).To(ContainSubstring("--pf-t--global--background--color--secondary--default: #f0f0f0"))
			Expect(rawHTML).To(ContainSubstring("--pf-t--global--background--color--primary--default: #ffffff"))
			Expect(rawHTML).To(ContainSubstring("--pf-t--global--text--color--regular: #333333"))
		})
	})
	...
	Context("Dark theme color overrides", func() {
		It("should inject CSS variable overrides in .pf-v6-theme-dark scope", func() {
			...
			rawHTML := provider.GetLoginForm()
			Expect(rawHTML).To(ContainSubstring(".pf-v6-theme-dark"))
			Expect(rawHTML).To(ContainSubstring("--pf-t--global--color--brand--default: #4da6ff"))
			Expect(rawHTML).To(ContainSubstring("--pf-t--global--color--brand--hover: #3d96ef"))
			Expect(rawHTML).NotTo(ContainSubstring("--pf-t--global--color--brand--clicked"))
			Expect(rawHTML).To(ContainSubstring("--pf-t--global--background--color--secondary--default: #1a1a2e"))
		})
	})
