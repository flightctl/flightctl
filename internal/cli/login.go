...
func (o *LoginOptions) Validate(args []string) error {
	...
	o.authProvider, err = o.getAuthProvider()
	if err != nil {
		return err
	}
...
func (o *LoginOptions) getAuthProvider() (login.AuthProvider, error) {
	...
	default:
		return nil, fmt.Errorf("unknown auth provider: %s", o.authConfig.AuthType)
	}
