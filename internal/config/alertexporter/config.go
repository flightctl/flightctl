...
// Config holds the configuration for the flightctl-alert-exporter service.
type Config struct {
...
// ServiceConfig holds alert exporter service-specific configuration.
type ServiceConfig struct {
	LogLevel             string        `json:"logLevel,omitempty"`
	AlertPollingInterval util.Duration `json:"alertPollingInterval,omitempty"`
}

// NewDefault returns a default alert exporter configuration.
...
// Load loads the alert exporter configuration from a file.
...
// AlertmanagerConfig returns the alertmanager configuration.
func (c *Config) AlertmanagerConfig() *common.AlertmanagerConfig {
