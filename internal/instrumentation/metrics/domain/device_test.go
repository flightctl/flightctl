...
func (m *MockDevice) Update(ctx context.Context, orgId uuid.UUID, device *domain.Device, fieldsToUnset []string, callback store.EventCallback) (*domain.Device, error) {
	return nil, nil
}
func (m *MockDevice) CreateOrUpdate(ctx context.Context, orgId uuid.UUID, device *domain.Device, fieldsToUnset []string, callback store.EventCallback) (*domain.Device, bool, error) {
