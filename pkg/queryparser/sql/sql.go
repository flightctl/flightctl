...
// other specialized functions (IN, NOTIN, LIKE, NOTLIKE, ISNULL, ISNOTNULL, CONTAINS, OVERLAPS, ANY, etc.).
func NewSQLParser(options ...SQLParserOption) (queryparser.Parser, error) {
	...
	sp.funcs = map[string]handler{
		...
		"ANY": {
			usedBy:        queryparser.NewSet[string]().Add(queryparser.RootFunc, "AND", "OR"),
			Verifications: []verificationHandler{withPrecedingKeyQuery(), withNoValues()},
			handle:        Wrap(sp.queryAny),
		},
		"NOTANY": {
			usedBy:        queryparser.NewSet[string]().Add(queryparser.RootFunc, "AND", "OR"),
			Verifications: []verificationHandler{withPrecedingKeyQuery(), withNoValues()},
			handle:        Wrap(sp.queryNotAny),
		},
		"ALL": {
			usedBy:        queryparser.NewSet[string]().Add(queryparser.RootFunc, "AND", "OR"),
			Verifications: []verificationHandler{withPrecedingKeyQuery(), withNoValues()},
			handle:        Wrap(sp.queryAll),
		},
		"NOTALL": {
			usedBy:        queryparser.NewSet[string]().Add(queryparser.RootFunc, "AND", "OR"),
			Verifications: []verificationHandler{withPrecedingKeyQuery(), withNoValues()},
			handle:        Wrap(sp.queryNotAll),
		},
		"CAST": {
			usedBy: queryparser.NewSet[string]().Add("EQ", "NOTEQ", "LT", "LTE", "GT", "GTE", "IN", "NOTIN", "LIKE",
				"NOTLIKE", "ANY", "NOTANY", "ALL", "NOTALL", "OVERLAPS", "NOTOVERLAPS", "CONTAINS", "NOTCONTAINS", "ISNULL", "ISNOTNULL"),
			Verifications: []verificationHandler{withPrecedingKeyOrValueQuery()},
			handle:        sp.queryCast,
		},
		"K": {
			usedBy: queryparser.NewSet[string]().Add("EQ", "NOTEQ", "LT", "LTE", "GT", "GTE", "IN", "NOTIN", "LIKE",
				"NOTLIKE", "ANY", "NOTANY", "ALL", "NOTALL", "OVERLAPS", "NOTOVERLAPS", "CONTAINS", "NOTCONTAINS", "ISNULL", "ISNOTNULL", "CAST"),
			handle: Wrap(sp.queryKey),
		},
		"V": {
			usedBy: queryparser.NewSet[string]().Add("EQ", "NOTEQ", "LT", "LTE", "GT", "GTE", "IN", "NOTIN", "LIKE",
				"NOTLIKE", "ANY", "NOTANY", "ALL", "NOTALL", "OVERLAPS", "NOTOVERLAPS", "CONTAINS", "NOTCONTAINS", "CAST"),
