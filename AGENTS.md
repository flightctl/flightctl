...
- **Service registry:** When adding a service, update [`hack/services.yaml`](hack/services.yaml) and run `make verify-services` (see [docs/developer/adding-a-service.md](docs/developer/adding-a-service.md)).
