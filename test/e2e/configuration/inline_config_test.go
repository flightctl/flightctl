...
var _ = Describe("Inline configuration tests", func() {
	...
	Context("Inline config tests", func() {
		...
		It("flighctl support inlineconfig with path, owner, permission and content", Label("78316", "sanity", "sanity_configuration"), func() {
		...
		It("Validations for flighctl inlineconfigs", Label("78364", "sanity", "sanity_configuration"), func() {
