...
The Keycloak OIDC and Keycloak-backed OAuth2 browser-login specs submit the provider login form with the Go HTTP client so they can run in headless CI environments without a local browser dependency.
