...
// TestServiceFailureObserver verifies startup failure detection across readiness and log states.
...
// TestServiceFailureObserverCanceled verifies that an already-canceled context stops polling.
