...
// copyFile copies the file at from to to.
// It ensures the destination directory exists (mode 0700) and creates or truncates the destination file.
// Returns an error if the source does not exist, the destination directory cannot be created, or any file I/O operation fails.
