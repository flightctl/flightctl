...
ifndef SKIP_BUILD
	...
	podman save localhost/flightctl-api-$(OS):latest | sudo podman load
	podman save localhost/flightctl-db-setup-$(OS):latest | sudo podman load
	podman save localhost/flightctl-worker-$(OS):latest | sudo podman load
	podman save localhost/flightctl-periodic-$(OS):latest | sudo podman load
	podman save localhost/flightctl-alert-exporter-$(OS):latest | sudo podman load
	podman save localhost/flightctl-cli-artifacts-$(OS):latest | sudo podman load
	podman save localhost/flightctl-alertmanager-proxy-$(OS):latest | sudo podman load
	podman save localhost/flightctl-pam-issuer-$(OS):latest | sudo podman load
	podman save localhost/flightctl-imagebuilder-api-$(OS):latest | sudo podman load
	podman save localhost/flightctl-imagebuilder-worker-$(OS):latest | sudo podman load
	podman save localhost/flightctl-userinfo-proxy-$(OS):latest | sudo podman load
	podman save localhost/flightctl-telemetry-gateway-$(OS):latest | sudo podman load
endif
