...
| dbSetup | object | `{"image":{"image":"quay.io/flightctl/flightctl-db-setup","pullPolicy":"","tag":""},"migration":{"activeDeadlineSeconds":0,"backoffLimit":0},"wait":{"sleep":2,"timeout":60}}` | Database Setup Configuration |
...
| dbSetup.migration.backoffLimit | int | `0` | Number of retries for the migration Job on failure (0 = unlimited) |
