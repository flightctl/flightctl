...
| dbSetup | object | `{"image":{"image":"quay.io/flightctl/flightctl-db-setup","pullPolicy":"","tag":""},"migration":{"activeDeadlineSeconds":600,"backoffLimit":2147483647},"wait":{"sleep":2,"timeout":60}}` | Database Setup Configuration |
...
| dbSetup.migration.activeDeadlineSeconds | int | `600` | Maximum runtime in seconds for the migration Job (0 = no deadline) Set to 10 minutes to prevent Helm hook timeouts during dry-run migrations |
