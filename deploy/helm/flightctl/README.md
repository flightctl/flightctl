...
| dbSetup | object | `{"image":{"image":"quay.io/flightctl/flightctl-db-setup-el9","pullPolicy":"","tag":""},"migration":{"activeDeadlineSeconds":1500,"backoffLimit":2147483647},"wait":{"sleep":2,"timeout":60}}` | Database Setup Configuration |
...
| imageBuilderWorker | object | `{"defaultTTL":"168h","enabled":true,"image":{"image":"quay.io/flightctl/flightctl-imagebuilder-worker-el9","pullPolicy":"","tag":""},"logLevel":"info","maxConcurrentBuilds":2,"privileged":true,"replicas":1,"resources":{}}` | ImageBuilder Worker Configuration |
