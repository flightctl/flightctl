...
clean_volumes() {
    # Remove volumes
    for volume in flightctl-db flightctl-api-certs flightctl-kv flightctl-ui-certs flightctl-cli-artifacts-certs flightctl-alertmanager flightctl-alertmanager-proxy flightctl-alert-exporter flightctl-pam-issuer-etc; do
